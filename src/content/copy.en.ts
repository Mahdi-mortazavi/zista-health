...
export const en: Copy = {
  ...
  personas: {
    ...
    h2: 'The same data, in three different languages.',
    intro:
      'A measurement is only useful if it reaches someone who can do something with it. Zista sends one continuous stream to three people, and speaks to each of them differently. The three lines below are the positions we are designing for, not quotations from customers. There are no customers yet.',
    items: [
      {
        id: 'patient',
        role: 'The patient',
        quote:
          '“I don’t want to think about it. I want to put something on and forget it.”',
        body: 'No charts to interpret, no daily readings to log. A ring that is charged twice a week. If something changes, you are told in a sentence, with the one thing to do about it. Not a number you have to search the internet to understand.',
      },
      {
        id: 'physician',
        role: 'The physician',
        quote: '“I need continuity, not more noise.”',
        body: 'Trends between visits, not a firehose. Thresholds you set yourself, per patient. A view you can read in fifteen seconds before you walk into the room, and an alert that has to earn its place in your day before it appears in it.',
      },
      {
        id: 'family',
        role: 'The family',
        quote:
          '“I live in another city. I call, and he says he’s fine, and I have no way to know.”',
        body: 'This is the part that is usually left out. You are not asking to read a medical file. You are asking whether today looks like last week. Zista answers that question, with the patient’s permission, in plain words, without turning a parent into a chart.',
      },
    ],
  },
